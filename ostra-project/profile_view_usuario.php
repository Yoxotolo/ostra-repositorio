<?php
// Este arquivo contém a VIEW completa para o perfil de USUÁRIO (Viber).
            ...
            <div class="user-profile">
                <div class="user-avatar">
                    <?php if ($profile_photo !== 'assets/default-avatar.svg'  ): ?>
                        <img src="<?php echo $profile_photo; ?>" alt="Avatar" style="width: 32px; height: 32px; border-radius: 50%; object-fit: cover;">
                    <?php else: ?>
...
<button class="edit-avatar-btn" id="editAvatarBtn">
                ...
                <div class="profile-info">
                    ...
                    <div class="profile-bio">
                        ...
                        <button class="btn-edit-bio" id="editBioBtn" onclick="editBio()">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11 4H4C3.46957 4 2.96086 4.21071 2.58579 4.58579C2.21071 4.96086 2 5.46957 2 6V20C2 20.5304 2.21071 21.0391 2.58579 21.4142C2.96086 21.7893 3.46957 22 4 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M18.5 2.50001C18.8978 2.10219 19.4374 1.87869 20 1.87869C20.5626 1.87869 21.1022 2.10219 21.5 2.50001C21.8978 2.89784 22.1213 3.4374 22.1213 4.00001C22.1213 4.56262 21.8978 5.10219 21.5 5.50001L12 15L8 16L9 12L18.5 2.50001Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
            ...
            <div class="tab-content">
                <div id="tab-musicas" class="tab-pane active">
                    <h2 class="config-title-small" style="margin-top: 40px;">Projetos (Álbuns)</h2>
                    <?php if (empty($user_projects)): ?>
                        <p>Este usuário ainda não tem projetos criados.</p>
                    <?php else: ?>
                    ...
                    <?php if (empty($user_music)): ?>
                        <p>Este usuário ainda não tem músicas avulsas enviadas.</p>
                    <?php else: ?>
