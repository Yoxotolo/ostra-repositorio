...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/11/2025 às 02:26
...
CREATE TABLE `musicas` (
  ...
  `ds_musica` varchar(20) DEFAULT NULL,
...
(2, 'miguelpro', 'miguelpropro', 'miguel11@gmail.com', '$2y$10$SNAOp6bKkjeRM4notaqx3uTRtU9vHPm40jNtISlKBneh3e4dRVNSC', 'produtor', NULL, 'https://res.cloudinary.com/dvlitdt5i/image/upload/v1763083515/ostra-project/profiles/profile_2_1763083467.png', NULL, '2025-10-31 01:05:10', '2025-11-14 01:24:31');
...
ALTER TABLE `musicas`
  ...
  ADD KEY `fk_cd_projeto` (`fk_cd_projeto`),
...
--
ALTER TABLE `musicas`
  ADD CONSTRAINT `musicas_ibfk_1` FOREIGN KEY (`fk_cd_projeto`) REFERENCES `projetos` (`cd_projeto`) ON DELETE SET NULL,
  ADD CONSTRAINT `musicas_ibfk_2` FOREIGN KEY (`fk_id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE;
